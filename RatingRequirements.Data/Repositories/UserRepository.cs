...
namespace RatingRequirements.Data.Repositories
{
	...
	public class UserRepository : IUserRepository
    {
        ...
        {
            return _dataContext.Connection.GetAll<User>().ToList();
        }
        ...
        {
            var data = _dataContext.Connection.GetAll<User>();
            if (filter != null)
            {
        ...
        {
            return _dataContext.Connection.Get<User>(id);
        }
    }
}
